...
<body>
    ...
    <div>
        ...
        <asp:DataList ID="CarList" runat="server" DataKeyField="CarID" DataSourceID="SqlDataSource1" OnItemCommand="CarList_ItemCommand">
            <ItemTemplate>
                CarID:
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MileageDBConnectionString %>" SelectCommand="SELECT * FROM [CarTable]"></asp:SqlDataSource>
        <br />
        ...
        <div>
            <h4>Add a new car</h4>
            <p>Car Make: <asp:TextBox ID="CarMake" runat="server"></asp:TextBox></p>
            <p>Manafacure: <asp:TextBox ID="Manafacture" runat="server"></asp:TextBox></p>
            <p>MPG: <asp:TextBox ID="MPG" runat="server" MaxLength="3"></asp:TextBox></p>
